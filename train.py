...
def parse_opt():
    ...
    parser.add_argument('--additional-training-dir', type=str, default='./dataset/additional-training-datasets/', help='dir folder additional training')
    parser.add_argument('--faces-save-dir', type=str, default='./dataset/face-datasets/', help='dir folder save face features')
    parser.add_argument('--features-save-dir', type=str, default='./feature/face_features', help='dir folder save face features')
